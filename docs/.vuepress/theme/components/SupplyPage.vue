<template>
	<div class="supply_container">
		<subpage_component :title="supplyData.pageTitle"></subpage_component>
		<div class="supply_summarize_project_content">
			<div class="supply_summarize_content">
				<p class="supply_summarize_label">{{supplyData.summarizeLabel}}</p>
				<summarize_section_component :section-data="supplyData.summarizeSection"></summarize_section_component>
			</div>
			<div class="project_content">
				<p class="project_label">{{supplyData.projectLabel}}</p>
				<project_list_component :project-list="supplyData.projectSection"></project_list_component>
			</div>
		</div>
